<template>
  <div class="surface-section px-4 py-8 md:px-6 lg:px-8">
    ...
    <div class="text-center text-xl line-height-3 text-600 mb-6">
      Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia
      deserunt mollit anim id est laborum.
    </div>
    <div class="grid">
      <div class="col-12 md:col-4 text-center mb-5">
        <img src="/blocks/avatars/circle-big/avatar-f-1.png" class="mb-3" />
      ...
      <div class="col-12 md:col-4 text-center mb-5">
        <img src="/blocks/avatars/circle-big/avatar-f-2.png" class="mb-3" />
      ...
      <div class="col-12 md:col-4 text-center mb-5">
        <img src="/blocks/avatars/circle-big/avatar-m-1.png" class="mb-3" />
      ...
      <div class="col-12 md:col-4 text-center mb-5">
        <img src="/blocks/avatars/circle-big/avatar-m-2.png" class="mb-3" />
      ...
      <div class="col-12 md:col-4 text-center mb-5">
        <img src="/blocks/avatars/circle-big/avatar-m-3.png" class="mb-3" />
      ...
      <div class="col-12 md:col-4 text-center mb-0 md:mb-5">
        <img src="/blocks/avatars/circle-big/avatar-f-3.png" class="mb-3" />
